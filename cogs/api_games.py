...
class APIGames(commands.Cog):
    """
    Fessenden Framework: Hybrid Omni-Game Suite (25/25 Games)
    Infrastructure: aiohttp.ClientSession (Non-blocking)
    Command Style: Hybrid (Works for both ! and /)
    """
    ...
    @commands.hybrid_command(name="country", description="Identify the country by its flag")
    async def country_guesser(self, ctx):
        ...
        embed.set_footer(text=f"Ref: {self.ms.generate_ref()}")
    ...
    @commands.hybrid_command(name="dog", description="Guess the dog breed from a photo")
    ...
    @commands.hybrid_command(name="pokelocation", description="Guess which Pokemon live in a specific area")
    ...
    @commands.hybrid_command(name="rating", description="Guess the Rotten Tomatoes score of a movie")
    async def movie_rating(self, ctx, *, movie: str):
        ...
        await ctx.send(f"🎬 **{data['Title']}**: Guess the score (0-100)!")
    ...
    @commands.hybrid_command(name="element", description="Guess the element from a scientific clue")
    ...
    @commands.hybrid_command(name="httpcat", description="Match the HTTP status code to the cat")
    ...
    @commands.hybrid_command(name="scramble", description="Guess the word from its dictionary definition")
    ...
    @commands.hybrid_command(name="insult", description="Survive an insult duel with the bot")
    ...
    @commands.hybrid_command(name="crypto", description="View live crypto prices")
    ...
    @commands.hybrid_command(name="color", description="Guess the name of a generated color")
    ...
    @commands.hybrid_command(name="cocktail", description="Guess the missing ingredient in a cocktail")
